...
if __name__ == "__main__":
    ...
    configureDataFlow("BenefitVerification", TARGET_ENVIRONMENT, security_credentials, config_json)
    #configureDataFlow("REGISTRATION", TARGET_ENVIRONMENT, security_credentials, config_json)
    #configureDataFlow("PATIENT_DEMOGRAPHY", TARGET_ENVIRONMENT, security_credentials, config_json)
    #configureDataFlow("ENGAGEMENTSURVEY", TARGET_ENVIRONMENT, security_credentials, config_json)
   # configureDataFlow("ENGAGEMENTSURVEY", TARGET_ENVIRONMENT, security_credentials, config_json)
    #configureDataFlow("OPT", TARGET_ENVIRONMENT, security_credentials, config_json)
